      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8">
            ...
            <a href="/api/auth/github" className="mt-4 flex items-center justify-center gap-3 w-full px-4 py-2.5 border border-nothing-grey-700 text-nothing-grey-300 text-xs font-mono uppercase tracking-wide hover:border-nothing-grey-500 hover:text-nothing-white transition-colors duration-300">
